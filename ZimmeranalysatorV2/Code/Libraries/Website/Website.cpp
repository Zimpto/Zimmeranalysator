...
void Website::printWebsite(double tem, double hum, double lux, short co2, uint16_t year, uint8_t mon, uint8_t mday, uint8_t hour, uint8_t minute, uint8_t sec, WiFiClient client)
{
	client.println("<html>");
	client.println("<head>");
